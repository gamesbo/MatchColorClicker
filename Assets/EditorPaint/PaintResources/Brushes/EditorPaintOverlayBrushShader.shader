...
Shader "Hidden/EditorPaint/Brush/Overlay" 
{
	Properties
	{
	}
		...
		Pass
      {
         ...
         #pragma target 3.0
	      ...
	      float4 frag(v2f i) : SV_Target
	      {
			  ...
			  float4 overlayResult = output < 0.5f ? (2.0f * output * _Color) : (1.0f - 2.0f * (1.0f - output) * (1.0f - _Color));
			  output = lerp(overlayResult, output, 1.0f - ((1.0f - brushTex) * _Color.a));
